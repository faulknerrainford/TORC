...
from TORC import GenetetA, SignalError, Supercoil, Channel, SupercoilSensitive
...
class TestSupercoilSensitive(TestCase):
    ...
    def test_update_sequential(self):
        ...
        promoter = SupercoilSensitive("red", supercoil.supercoiling_region, output_channel=test_out_queue)
        promoter.update()
    ...
    def test_update_concurrent(self):
        ...
        test_out_queue = Queue()
        promoter = SupercoilSensitive("blue", supercoil_2.supercoiling_region, output_channel=test_out_queue)
    ...
    def test_input_check(self):
        ...
        supercoil = Supercoil(sc_channel)
        test_out_queue = Queue()
        ss_promoter = SupercoilSensitive("green", supercoil.supercoiling_region, output_channel=test_out_queue)
